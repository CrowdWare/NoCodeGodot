...
public static class SchemaFunctions
{
    ...
    [
        ...
        new FunctionDef("i18n.getLocale", "Internationalization", "i18n.getLocale()", "Returns the active two-letter ISO language code (for example: en, de, es)."),
        ...
        new FunctionDef("os.callStatic", "OS", "os.callStatic(assemblyPath: String, typeName: String, methodName: String, ...args)", "Loads a .NET assembly and invokes a static method by reflection. Returns the method result converted to an SMS value."),
        ...
        new FunctionDef("os.getEnv", "OS", "os.getEnv(name: String)", "Returns the process environment variable value or empty string if unset."),
        ...
        new FunctionDef("os.resolvePath", "OS", "os.resolvePath(path: String)", "Resolves res:/, user:/ and relative paths to an absolute filesystem path."),
        new FunctionDef("os.setEnv", "OS", "os.setEnv(name: String, value: String)", "Sets a process-level environment variable for the running app session. Not persisted system-wide."),
        new FunctionDef("ui.configureNumericLineEdit", "UI", "ui.configureNumericLineEdit(id: String, axis: String, unit: String, color: String, step: float, dragSensitivity: float, decimals: int)", "Enables editor-like numeric behavior on a LineEdit: select-all on focus, drag-to-adjust while unfocused, and formatted preview text (for example: x 3.788 m)."),
        ...
        new FunctionDef("ui.getNumericLineEditValue", "UI", "ui.getNumericLineEditValue(id: String)", "Returns the current numeric value of a configured numeric LineEdit as a float."),
        new FunctionDef("ui.setNumericLineEditValue", "UI", "ui.setNumericLineEditValue(id: String, value: float)", "Sets the numeric value of a configured numeric LineEdit and refreshes its displayed preview/raw text."),
