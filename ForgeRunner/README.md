# Forge-Runner – Technical Documentation

## Overview

Forge-Runner is the runtime environment for Forge projects created with the Forge-Designer.
...
The Forge-Runner loads SML documents from a remote source (e.g. GitHub Pages), resolves and caches assets locally, parses SML at runtime, and dynamically builds the corresponding Godot Node tree using C#.
...
The manifest is the entry point for every Forge project.
...
- `--url file:///Users/art/SourceCode/Forge/docs/SampleProject/UI.sml`
- `file:///Users/art/SourceCode/Forge/docs/SampleProject/UI.sml`
