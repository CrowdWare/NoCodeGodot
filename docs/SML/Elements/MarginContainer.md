...
[MarginContainer](MarginContainer.md) → [Container](Container.md) → [Control](Control.md) → [CanvasItem](CanvasItem.md) → [Node](Node.md) → [Object](Object.md)
...
This page lists **only properties declared by `MarginContainer`**.
...
This page lists **only signals declared by `MarginContainer`**.
